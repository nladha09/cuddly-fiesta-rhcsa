...
> <span style="font-family:courier new">**Task 2. Interrupt the boot process to set the root password as "password"**:</span>

Procedure:
- Reboot the system.
- Wait for GRUB menu to appear and then press "e" to edit.
- Find the line starting w/ "linux16" & enter the "rd.break" at the end.
