...
**I am following along Prince Bajaj's very helpful [Udemy Course](https://www.udemy.com/course/rhcsa-practice-exam-questions-ex200-redhat-release-7/) to create this study guide. & using @rdbreak's easy-to-use [practice env.](https://github.com/rdbreak/rhcsa8env)**
...
**TODO**:
- [x] ~~Build VM~~
- [x] ~~verify build that will be administered on exam~~
- [x] ~~verify materials that can be used for help~~
- [x] ~~look up how patches / updates are done on RHEL 8 (licensing involved?)~~
